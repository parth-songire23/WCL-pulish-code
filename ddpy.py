...
class Agent:
    ...
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99, 
        ...
        self.critic = CriticNetwork(beta, input_dims, layer1_size, layer2_size, n_actions, name='Critic')

        self.target_actor = ActorNetwork(alpha, input_dims, layer1_size, layer2_size, n_actions, name='TargetActor')
        self.target_critic = CriticNetwork(beta, input_dims, layer1_size, layer2_size, n_actions, name='TargetCritic')
